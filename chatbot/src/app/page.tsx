                ...
                <div className="flex">
                  ...
                  <div className="ml-3">
                    <p className="text-sm text-blue-700 dark:text-blue-300">
                      This tool does NOT store any user data. Answers are generated with AI based on publicly available information, please use discretion when using the answers. The underlying RAG knowledge base of this assistant is trained on BIAN 12.0 Service Landscape, BIAN Book 2nd Edition, and Web Search augmentation.
                    </p>
                  </div>
                </div>
              </div>
